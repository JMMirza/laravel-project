                    ...
                    <div class="login-screen-right col-md-12">
                        <div class="login-screen-inner right-contnet signup">
                            ...
                            <div class="third-section">
                                <form method="POST" class="m-t register-form" role="form"
                                    ...
                                    <div class="form-group">
                                        <input id="mobile_number" type="text"
                                            ...
                                            data-inputmask="'mask': '03999999999'" autocomplete="mobile_number"
                                            autofocus placeholder="{{ __('Mobile Number') }} (eg: 03319636191)">
                                        @error('mobile_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select class="form-control m-b  @error('gender') is-invalid @enderror"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input id="cnic_number" type="text"
                                                    class="form-control @error('cnic_number') is-invalid @enderror"
                                                    name="cnic_number" value="{{ old('cnic_number') }}"
                                                    data-inputmask="'mask': '99999-9999999-9'"
                                                    autocomplete="cnic_number" autofocus
                                                    placeholder="{{ __('CNIC Number') }} (eg: 384038953093)">
                                                @error('cnic_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="btn_forget_password d-flex justify-content-between">
                                        <button type="submit"
                                            class="btn btn-primary block full-width m-b mt-3 login-btn">
                                            Signup
                                        </button>
                                    </div>
                                    <a class="btn btn-outline btn-primary dim btn-block"
                                        href="{{ route('login') }}"><strong>Already have a account</strong></a>
                                </form>
                            </div>
                        </div>
                    </div>
