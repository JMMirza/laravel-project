    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-8 text-left" style="padding-left:0px;">
                    <h2 style="margin-bottom: 0px;" class="font-bold">
                        {{ __('Welcome to Teach for Change-SEF') }}
                    </h2>
                    <p style="margin: 0px;">
            ...
            <p>
                ...
                {{ __('Do Teach for Change-SEF login for online registration.') }}
            </p>
            <p>
                <strong>
                    {{ __('Step 2:') }}
                </strong>
                {{ __('Sign up for an account. Please remember the username and password as your roll no slip and result will be delievered to this email provided to Teach for Change-SEF.') }}
            </p>
            <p>
                <strong>
                    {{ __('Step 3:') }}
                </strong>
                {{ __('After signing up, you will receive a confirmation email to the email provided at Teach for Change-SEF portal. Click on verify your account link.') }}
            </p>
