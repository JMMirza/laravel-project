                    ...
                    <div class="mail-box">
                        <form method="post" action="{{ route('raise-support-ticket') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{ \Auth::user()->email }}"
                                            readonly name="from_email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">To:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="sefteachforchange@gmail.com"
                                            readonly name="to_email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value=""
                                            placeholder="Please enter your subject" name="email_subject">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mail-body text-right tooltip-demo">
                                <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-reply"></i>
                                    Send</button>
                                <button type="reset" class="btn btn-white btn-sm"><i class="fa fa-times"></i>
                                    Discard</button>
