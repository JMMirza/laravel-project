...
@section('content')
    @if (isset($school))
        @include('exam_center.schools.edit_school')
    @else
        @include('exam_center.schools.add_school')
    @endif
                    ...
                    <div class="ibox-content">
                        <div class="wrapper wrapper-content">
                            <div class="table-responsive">
                                <table id="schools-list" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
...
@push('footer_scripts')
    <script>
        $(document).ready(function() {
            ...
            // init datatable.
            var jobList = $('#schools-list').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                autoWidth: false,
