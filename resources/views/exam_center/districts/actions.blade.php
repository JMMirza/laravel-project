<div class="btn-group">
    ...
    <a href="{{ route('districts.edit', $row->id) }}" class="btn btn-sm btn-success btn-icon waves-effect waves-light">
        <i class="fa fa-pencil" aria-hidden="true"></i>
    </a>
    {{-- @endpermission --}}

    {{-- @permission('delete-city') --}}
    <a href="{{ route('districts.destroy', $row->id) }}" data-table="districts-list"
