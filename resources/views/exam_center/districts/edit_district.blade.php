            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content pb-1">
                    <form class="m-t" role="form" method="post"
                        action="{{ route('districts.update', $district->id) }}" id="form_exam_center">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="name" type="text"
                                        ...
                                        placeholder="Please Enter District Name" value="{{ $district->name }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="abbreviation" id="abbreviation" type="abbreviation"
                                        ...
                                        placeholder="Please Enter Abbreviation" value="{{ $district->abbreviation }}">
                                    @error('abbreviation')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
