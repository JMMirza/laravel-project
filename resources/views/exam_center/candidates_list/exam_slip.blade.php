...
<body class="A4">
    ...
    <section class="sheet padding-10mm watermark">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 85%;">
                    ...
                    <p style="font-size: 12px;">
                        <strong>{{ $data->timeslot->exam_calander->exam_center->name }}</strong>
                    </p>
                    <p style="font-size: 12px;">
        ...
        <ul>
            ...
            <li>Mobile phones, smartwatches and other electronic gadgets are NOT allowed in the examination hall
                otherwise strict disciplinary action shall be taken which may also lead to cancellation of paper and
                will be debarred from appearing in the upcoming MDCAT Exam</li>
            <li>Strict disciplinary action shall be taken against candidates found creating noise and distraction in or
                around the exam center. It may lead to cancellation of paper or debarring from the examination</li>
        ...
        <table id="signature">
            ...
            <tr>
                <td><strong>Examination Officer <br />Teach for Change-SEF Examination Department</strong></td>
            </tr>
        </table>
        <hr />
