...
use App\Http\Controllers\JobPrefrenceController;
...
Route::group(['middleware' => ['role:administrator', 'verified']], function () {
	...
	Route::get('/job-candidate-info/{id}', [UserController::class, 'job_candidate_info'])->name('job-candidate-info');
	Route::get('/job-candidate-list/{id}', [UserController::class, 'job_candidate_lists'])->name('job-candidate-list');
	Route::get('/shortlisted-candidate-info/{id}', [UserController::class, 'shortlisted_candidate_info'])->name('shortlisted-candidate-info');
	Route::post('/shortlist-all-candidates', [UserController::class, 'shortlist_all_candidates'])->name('shortlist-all-candidates');
	Route::get('/invited-candidate-info/{id}', [UserController::class, 'invited_candidate_info'])->name('invited-candidate-info');
	Route::post('/invite-all-candidates', [UserController::class, 'invite_all_candidates'])->name('invite-all-candidates');
	Route::post('/export-shortlisted-candidates', [UserController::class, 'ExportShortlistedCandidates'])->name('export-shortlisted-candidates');
	...
	Route::resources(['districts' => DistrictController::class]);
	Route::resources(['talukas' => TalukaController::class]);
	Route::resources(['union-councils' => UnionCouncilController::class]);
	Route::resources(['schools' => SchoolController::class]);
...
Route::group(['middleware' => ['role:administrator|examiner', 'verified']], function () {
	...
	Route::resources(['job-lists' => JobAnnouncementController::class]);
...
Route::group(['middleware' => ['role:user', 'verified']], function () {
	...
	Route::get('/edit-educational-document/{id}', [CandidateDocumentController::class, 'edit'])->name('edit-educational-document');
	Route::put('/update-educational-document/{id}', [CandidateDocumentController::class, 'update'])->name('update-educational-document');
	Route::post('/delete-educational-document/{id}', [CandidateDocumentController::class, 'delete'])->name('delete-educational-document');
	Route::get('/get-qualification', [UserController::class, 'userQualification'])->name('get-qualification');
	Route::resources(['user-experiences' => UserExperienceController::class]);
	Route::resources(['upload-csv' => VillageController::class]);
	Route::resources(['user-certificates' => UserCertificateController::class]);
	Route::get('/view-certificate-document/{id}', [UserCertificateController::class, 'viewDocument'])->name('view-certificate-document');
	...
	Route::get('/list-talukas', [CommonController::class, 'listTalukas'])->name('list-talukas');
	Route::get('/list-villages', [CommonController::class, 'listVillages'])->name('list-villages');
	Route::get('/list-union-councils', [CommonController::class, 'listUnionCouncils'])->name('list-union-councils');
	Route::get('/list-schools', [CommonController::class, 'listSchools'])->name('list-schools');
	...
	Route::get('/load-job-detail', [UserController::class, 'loadJobDetail'])->name('load-job-detail');
	Route::get('/load-job-prefrences', [UserController::class, 'loadJobPrefrences'])->name('load-job-prefrences');
	Route::resources(['job-applications' => JobApplicationController::class]);
	Route::resources(['job-preferences' => JobPrefrenceController::class]);
	Route::get('/print-job-app/{id}', [JobApplicationController::class, 'printJobApp'])->name('print-job-app');
	// Route::get('/print-job-app/{id}', [JobApplicationController::class, 'printJobApp'])->name('print-job-app');
	Route::get('/download-test-slip/{id}', [JobApplicationController::class, 'testSlip'])->name('download-test-slip');
	Route::get('download-add/{id}', [JobAnnouncementController::class, 'viewAdd'])->name('download-add');
	Route::get('/how-to-apply', [JobAnnouncementController::class, 'howToApply'])->name('how-to-apply');
	Route::get('/review-job-application', [UserController::class, 'reviewJob'])->name('review-job-application');
	Route::get('/job-apply', [UserController::class, 'jobApply'])->name('job-apply');
});
...
Route::group(['middleware' => ['role:administrator|examiner|user', 'verified']], function () {
	...
	Route::get('/list-cities', [CommonController::class, 'listCities'])->name('list-cities');
	Route::get('/list-talukas', [CommonController::class, 'listTalukas'])->name('list-talukas');
	Route::get('/list-taluka-profile', [CommonController::class, 'listTalukaProfiles'])->name('list-taluka-profile');
	Route::get('/list-villages', [CommonController::class, 'listVillages'])->name('list-villages');
	Route::get('/list-union-councils', [CommonController::class, 'listUnionCouncils'])->name('list-union-councils');
	Route::get('/list-schools', [CommonController::class, 'listSchools'])->name('list-schools');
